  ...
  const sections = [
    {
      ...
      content: [
        'GarageWala provides doorstep vehicle maintenance and repair services',
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm leading-relaxed">
                    These terms constitute a legally binding agreement between you and GarageWala. 
          ...
          <Card className="bg-white/90 backdrop-blur-lg border border-white/20">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                By accessing and using GarageWala's services, you acknowledge that you have read, 
