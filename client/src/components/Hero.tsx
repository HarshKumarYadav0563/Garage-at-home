...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[45vh] sm:min-h-[50vh] lg:min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-black pt-16 sm:pt-18 lg:pt-2">
      {/* Radial Accent Glows */}
